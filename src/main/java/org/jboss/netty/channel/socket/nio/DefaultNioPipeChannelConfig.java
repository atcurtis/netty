 ...
 */
public class DefaultNioPipeChannelConfig extends DefaultChannelConfig implements NioPipeChannelConfig
{
  ...
  private static final int DEFAULT_MAXIMUM = 4096;

  private static final ReceiveBufferSizePredictorFactory DEFAULT_PREDICTOR_FACTORY =
      new AdaptiveReceiveBufferSizePredictorFactory(DEFAULT_MINIMUM, DEFAULT_INITIAL, DEFAULT_MAXIMUM);
